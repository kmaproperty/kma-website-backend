...
export class AdminAmenityListQueryDto {
  @ApiPropertyOptional({
...
export class AdminAmenityResponseDto {
  @ApiProperty()
  id: string;
...
export class AdminCreateAmenityDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Unique amenity code (used for lookups)',
    example: 'swimming-pool',
  })
  @IsString()
  @IsNotEmpty()
...
export class AdminUpdateAmenityDto extends PartialType(AdminCreateAmenityDto) {}
