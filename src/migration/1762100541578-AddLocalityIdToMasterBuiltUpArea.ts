...
export class AddLocalityIdToMasterBuiltUpArea1762100541578 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "master_built_up_areas" ADD "locality_id" uuid`);
        await queryRunner.query(`ALTER TABLE "master_built_up_areas" DROP CONSTRAINT "FK_65eb7a4d29c8d75aa6591824e87"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "master_built_up_areas" DROP CONSTRAINT "FK_cbc75e9fd1c29256420addc238c"`);
        await queryRunner.query(`ALTER TABLE "master_built_up_areas" DROP CONSTRAINT "FK_65eb7a4d29c8d75aa6591824e87"`);
